...
class Game:
    ...
    def update(self):
        ...
        for invader in self.invaders:
            invader.update()
            if invader.rect.x <= 0 or invader.rect.x >= SCREEN_WIDTH - invader.rect.width:
                move_down = True
        ...
        if current_time - self.invader_shoot_timer > 1000 and self.invaders:
            ...
            bullet = Bullet(shooting_invader.rect.x + shooting_invader.rect.width // 2,
                            shooting_invader.rect.y + shooting_invader.rect.height, -1)
        ...
        for invader in self.invaders:
            if invader.rect.y + invader.rect.height >= self.player.rect.y:
                self.game_over = True
